...
export function Sidebar({
  ...
  return (
    <div className="flex flex-col h-full w-full bg-gray-900 text-white" role="navigation">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <span
                className={`inline-block w-1.5 h-1.5 rounded-full ${isConnected ? "bg-green-400" : "bg-red-400"}`}
              />
      ...
      {sessions.length > 0 && (
        <div className="px-3 mb-2 pt-2">
          <input
            ...
            className="w-full px-3 py-1.5 text-sm bg-gray-800 border border-gray-700 rounded-lg text-gray-200 placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          />
        </div>
      )}
              ...
              <div className="text-xs text-left space-y-2 px-2">
                <div className="flex gap-2">
                  ...
                  <span className="text-gray-400">
                    Click <strong className="text-gray-300">New Session</strong> above
                  </span>
                </div>
                <div className="flex gap-2">
            ...
            {filteredSessions.map((session) => (
              <div
                ...
                className={`group flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer transition-colors ${
                  selectedSessionId === session.id ? "bg-gray-700" : "hover:bg-gray-800"
                }`}
